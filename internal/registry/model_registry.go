...
type ThinkingSupport struct {
	...
	ZeroAllowed bool `json:"zero_allowed,omitempty" toml:"zero-allowed,omitempty"`
	// DynamicAllowed indicates whether -1 is a valid value (dynamic thinking budget).
	DynamicAllowed bool `json:"dynamic_allowed,omitempty" toml:"dynamic-allowed,omitempty"`
	...
	Levels []string `json:"levels,omitempty" toml:"levels,omitempty"`
}
